...
@section('title', 'Airefs Analytics')

@section('content')
  <div class="card card-lg p-0 content">
    <header class="py-6 px-8 border-b">
      <h1>Airefs Analytics</h1>
      <p>Automatically connects to your Airefs Analytics account and updates your data-tracking when bots hit your website.</p>
    </header>
